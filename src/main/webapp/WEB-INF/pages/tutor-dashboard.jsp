...
<section>
    <div class="mt-12 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div class="block sm:flex gap-4">
            ...
            <a href="new-student"
               class="block rounded-md text-center bg-indigo-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Add
                student</a>
        </div>
    </div>
                    ...
                    <div class="grid grid-cols-6 gap-4 divide-y sm:divide-y-0">
                        ...
                        <div class="p-2 hover:bg-slate-200 hover:rounded-md col-span-6 sm:col-span-3 md:col-span-2 pt-4 md:pt-0">
                            ...
                            <a href="edit-student?studentId=${student.id}" class="col-span-6 sm:col-span-2">
                                <dl>
                                    <l:data-group title="Company Name"><c:out
                                            value="${student.internshipByIdInternship.companyName}"/></l:data-group>
                                    <l:data-group title="Address"><c:out
                                            value="${student.internshipByIdInternship.companyAddress}"/></l:data-group>
                                    <l:data-group title="Company Tutor"><c:out
                                            value="${student.internshipByIdInternship.companyTutor}"/></l:data-group>
                                    ...
                                    <l:data-group title="Mission"><c:out
                                            value="${student.internshipByIdInternship.mission}"/></l:data-group>
                                </dl>
                            </a>
